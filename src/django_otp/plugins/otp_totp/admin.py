...
class TOTPDeviceAdmin(admin.ModelAdmin):
    ...
    def get_urls(self):
        urls = [
            re_path(r'^(?P<pk>\d+)/config/$', self.admin_site.admin_view(self.config_view), name='otp_totp_totpdevice_config'),
            re_path(r'^(?P<pk>\d+)/qrcode/$', self.admin_site.admin_view(self.qrcode_view), name='otp_totp_totpdevice_qrcode'),
        ] + super().get_urls()
